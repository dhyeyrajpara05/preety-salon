...
const ProductSchema = new mongoose.Schema({
    ...
    psubcategory: { type: String, default: '' },
...
const PaymentSchema = new mongoose.Schema({
    paymentid: { type: String, unique: true, sparse: true }, // unique but sparse to allow multiple nulls during created phase
    orderid: { type: String, required: true }, // Razorpay Order ID (from rzp)
    internalOrderId: { type: String }, // ORD...
    userid: { type: String },
    amount: { type: Number },
    price: { type: Number }, // To match user's demo
    currency: { type: String, default: 'INR' },
    status: { type: String, default: 'created' }, // created, captured, failed
    method: { type: String },
    email: { type: String },
    contact: { type: String },
...
module.exports = { User, Product, Order, Cart, Category, Service, Package, Appointment, Customer, MembershipPlan, Staff, Invoice, Feedback, ProductReview, Inquiry, Notification, Payment, payment: Payment };
