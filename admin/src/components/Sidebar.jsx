...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="overplay-menu d-lg-none"></div>
      <div className="section-menu-left">
        <div className="box-logo">
          <Link to="/" id="site-logo-inner" style={{ textDecoration: 'none', fontSize: '22px', fontWeight: '700', color: '#111' }}>
            Preety Salon
          </Link>
        </div>
          ...
          <div className="center">
            <div className="center-item">
              <ul className="">
                ...
                <li className={`menu-item ${location.pathname === '/product' ? 'active' : ''}`}>
                  <Link to="/product" className="">
                    <div className="icon"><i className="icon-shopping-cart"></i></div>
                    <div className="text">Products</div>
                  </Link>
                </li>
                <li className={`menu-item ${location.pathname === '/category' ? 'active' : ''}`}>
                ...
                <li className={`menu-item ${location.pathname === '/packages' ? 'active' : ''}`}>
                  <Link to="/packages" className="">
                    <div className="icon"><i className="icon-package"></i></div>
                    <div className="text">Packages</div>
                  </Link>
                </li>
                <li className={`menu-item ${location.pathname === '/appointments' ? 'active' : ''}`}>
                  <Link to="/appointments" className="">
                    <div className="icon"><i className="icon-calendar"></i></div>
              ...
              <li className={`menu-item ${location.pathname === '/invoices' ? 'active' : ''}`}>
                <Link to="/invoices" className="">
                  <div className="icon"><i className="icon-file-text"></i></div>
                  <div className="text">Invoices</div>
                </Link>
              </li>
              <li className={`menu-item ${location.pathname === '/membership' ? 'active' : ''}`}>
                <Link to="/membership" className="">
                  <div className="icon"><i className="icon-award"></i></div>
              ...
              <li className={`menu-item ${location.pathname === '/notifications' ? 'active' : ''}`}>
                ...
                <li className={`menu-item ${location.pathname === '/staff' ? 'active' : ''}`}>
                  <Link to="/staff" className="">
                    <div className="icon"><i className="icon-user"></i></div>
                    <div className="text">Staff Management</div>
                  </Link>
                </li>

                <li className="menu-item">
                  <a href="#" className="" onClick={(e) => { e.preventDefault(); handleLogout(); }}>
                    <div className="icon">
